...
//  13-En son adim olarak butun sayfalarimizi kapatmis olalim
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String sahibindenCurrentUrl = driver.getCurrentUrl();
        System.out.println(" page current URL : " + driver.getCurrentUrl());

        if (sahibindenTitle.contains("Oto") && sahibindenCurrentUrl.contains("Oto")) {

            System.out.println("Oto yazisi vardır");
        ...
        System.out.println("gg title : " + driver.getTitle());
